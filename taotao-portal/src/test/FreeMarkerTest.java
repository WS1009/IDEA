...
public class FreeMarkerTest {
    ...
    public void testFreeMarker() throws Exception {
        ...
        configuration.setDirectoryForTemplateLoading(new File("E:\\AS_Eclipse_WorkSpace\\IDEA_Space\\Test\\taotao\\taotao-portal\\src\\main\\webapp\\WEB-INF\\ftl"));
        ...
        stuList.add(new Student(1,"张三1","北京1"));
